...
const Home = () => {
    ...
    const data1 = [svg1, svg2, svg3, svg4, svg5];
    const data2 = [svg6, svg7, svg8, svg9, svg10];

    return (
        <>
            <section ref={s1} className="introSection">
                <div className="contentContainer">
                    <h4 className="introTitle" data-aos="zoom-in-up">
                        INTRODUCING
                    </h4>
                    <h1 className="introHeading" data-aos="zoom-in-up">
                        MetaBlock
                    </h1>
            ...
            <section className="aboutSection ">
                ...
                </div>
                {
                    <div className="aboutRight">
                        <p className="font aboutTitle" data-aos="fade-left">
                            MetaBlock
                        </p>
                        ...
                        <p
                            className="aboutDescription mt-3 paraFont"
                            data-aos="fade-left"
                        >
            ...
            <section className="roadMapContainer appContainer my-5" ref={s4}>
                <h1
                    className="roadMapHeading text-center"
                    data-aos="zoom-in-up"
                >
                    PARTNERS
                </h1>
            ...
            <section className="appContainer stakeSection">
                ...
                <div className="stakeRight">
                    <h1 className="stakHeading" data-aos="fade-left">
                        Staking
                    </h1>
                    ...
                    <div>
                        <>
                            ...
                            <p className="font subDesc" data-aos="fade-left">
                                ...
                                unlock rewards, enhancing the value and utility
                                of your digital assets within the blockchain
                                ecosystem.
                            </p>
                        </>
                    </div>
            ...
            <section className="featureHeader appContainer" ref={s5}>
                <div className="headerLeft">
                    <h5 className="header5 " data-aos="fade-right">
                        {" "}
                        FEATURES IN
                    </h5>

                    <h2 className="header2" data-aos="fade-right">
                        {" "}
                        METABLOCK
                    </h2>
                </div>
                <div className="headerRight">
                    <h2
                        className="rightHeader aboutHeading"
                        data-aos="fade-left"
                    >
                        Navigating Tomorrow's Digital Frontiers with Versatile
                        Solutions
                    </h2>
                    <p className="rightPara" data-aos="fade-left">
                        Explore Horixon, a multifaceted venture spearheading the
                        future of technology. From immersive travel in
                        Horixpanse to thrilling bets in Horixbet, groundbreaking
                        innovation awaits. Join us on this transformative
                        journey through the metaverse and beyond.
                    </p>
                </div>
            </section>
